...
function rainbow_parenthsis#Activate()
    highlight default level1c  ctermbg=black ctermfg=brown        guibg=black  guifg=RoyalBlue3
    highlight default level2c  ctermbg=black ctermfg=Darkblue     guibg=black  guifg=SeaGreen3
    highlight default level3c  ctermbg=black ctermfg=darkgray     guibg=black  guifg=DarkOrchid3
    highlight default level4c  ctermbg=black ctermfg=darkgreen    guibg=black  guifg=firebrick3
    highlight default level5c  ctermbg=black ctermfg=darkcyan     guibg=black  guifg=RoyalBlue3
    highlight default level6c  ctermbg=black ctermfg=darkred      guibg=black  guifg=SeaGreen3
    highlight default level7c  ctermbg=black ctermfg=darkmagenta  guibg=black  guifg=DarkOrchid3
    highlight default level8c  ctermbg=black ctermfg=brown        guibg=black  guifg=firebrick3
    highlight default level9c  ctermbg=black ctermfg=gray         guibg=black  guifg=RoyalBlue3
    highlight default level10c ctermbg=black ctermfg=black        guibg=black  guifg=pink
    highlight default level11c ctermbg=black ctermfg=darkmagenta  guibg=black  guifg=orange
    highlight default level12c ctermbg=black ctermfg=Darkblue     guibg=black  guifg=yellow
    highlight default level13c ctermbg=black ctermfg=darkgreen    guibg=black  guifg=RoyalBlue3
    highlight default level14c ctermbg=black ctermfg=darkcyan     guibg=black  guifg=pink
    highlight default level15c ctermbg=black ctermfg=darkred      guibg=black  guifg=DarkOrchid3
    highlight default level16c ctermbg=black ctermfg=red          guibg=black  guifg=SeaGreen3
