...
(defvar noctilux-colors           ; ANSI(Noctilux terminal)
  ...
  '((base03  "#000000" "#000000" "#000000" "brightblack"   "black")
    ...
    (base04  "#333333" "#333333" "#333333" "brightyellow"  "green")         ; Selection
    ...
    (green   "#afd7af" "#afd7af" "#afd7af" "green"         "green"))        ; variable type
      ...
      (let ((back base03))
        ...
        (let ((bg-back   `(:background ,back))
          ...
          `((;; basic
             ...
             (region ((t (,@fg-base04 ,@bg-base2 ,@fmt-revbb)))) ; Visual
             (secondary-selection ((t (,@bg-base04))))
             (shadow ((t (,@fg-base01))))
             ...
             (helm-selection ((t (,@fg-green ,@bg-base04))))
