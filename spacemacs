...
layers configuration. You are free to put any user code."
  ...
  ;;(require 'key-chord)
  ;;(key-chord-mode 1)
  ;;(key-chord-define evil-emacs-state-map  ",." 'switch-to-prev-buffer)

  (spacemacs/set-leader-keys "w v" 'smp/hsplit)
  (spacemacs/set-leader-keys "w s" 'smp/vsplit)
  (spacemacs/set-leader-keys "." 'switch-to-previous-buffer)
