...
if exists("g:ada_with_gnat_project_files")
   let s:AdaBlockStart = '^\s*\(if\>\|while\>\|else\>\|elsif\>\|loop\>\|for\>.*\<\(loop\|use\)\>\|declare\>\|begin\>\|type\>.*\<is\>[^;]*$\|\(type\>.*\)\=\<record\>\|accept\>\|do\>\|task\>\|package\>\|project\>\|then\>\|when\>\|is\>\)'
else
   let s:AdaBlockStart = '^\s*\(if\>\|while\>\|else\>\|elsif\>\|loop\>\|for\>.*\<\(loop\|use\)\>\|declare\>\|begin\>\|type\>.*\<is\>[^;]*$\|\(type\>.*\)\=\<record\>\|accept\>\|do\>\|task\>\|package\>\|then\>\|when\>\|is\>\)'
endif
...
function GetAdaIndent()
   ...
   elseif line =~ '^\s*\(begin\|is\)\>'
	   let ind = s:MainBlockIndent( ind, lnum, '\(declare\|package\|task\)\>', 'begin\>' ) - &sw
   elseif line =~ '^\s*record\>'
      let ind = s:MainBlockIndent( ind, lnum, 'type\>\|for\>.*\<use\>', '' ) + &sw
   elseif line =~ '^\s*\(else\|elsif\)\>'
      let ind = s:MainBlockIndent( ind, lnum, 'if\>', '' ) - &sw
   elseif line =~ '^\s*when\>'
   ...
   elseif line =~ '^\s*end\>'
      ...
      let ind = s:EndBlockIndent( ind, lnum, 'if\|while\|for\|loop\|accept\|begin\|record\|case\|exception\|package\)\>', '' )
